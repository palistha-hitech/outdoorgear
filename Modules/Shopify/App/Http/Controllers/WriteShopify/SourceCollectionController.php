    ...
    public function index(Request $request)
    {
        ...
        try {
            if ($id) {
                ...
                $categories = $this->categoryService->getAllCategory($limit);
            }
            if ($debug == 1) {
                dd($categories);
            }
            ...
            foreach ($categories as $category) {
                ...
                if (!empty($response->data->collectionCreate->userErrors) || !empty($response->data->collectionUpdate->userErrors)) {
                    dump('error');
                    ...
                    $updatedata = [
                        ...
                        'shopifyPendingProcess' => 3, // 3 means error in creating collection
